...
namespace CafeWebsite.Migrations
{
    ...
    [Migration("20250919141505_AddUserAndPromotionFeatures")]
    partial class AddUserAndPromotionFeatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CafeWebsite.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Available = true,
                            Category = 0,
                            CreatedAt = new DateTime(2025, 9, 19, 21, 15, 5, 32, DateTimeKind.Local).AddTicks(5643),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            Category = 0,
                            CreatedAt = new DateTime(2025, 9, 19, 21, 15, 5, 33, DateTimeKind.Local).AddTicks(3821),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            Category = 1,
                            CreatedAt = new DateTime(2025, 9, 19, 21, 15, 5, 33, DateTimeKind.Local).AddTicks(3835),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            Category = 2,
                            CreatedAt = new DateTime(2025, 9, 19, 21, 15, 5, 33, DateTimeKind.Local).AddTicks(3840),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            Category = 3,
                            CreatedAt = new DateTime(2025, 9, 19, 21, 15, 5, 33, DateTimeKind.Local).AddTicks(3844),
            ...
            modelBuilder.Entity("CafeWebsite.Models.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "promo1",
                            Code = "WELCOME20",
                            CreatedAt = new DateTime(2025, 9, 19, 21, 15, 5, 33, DateTimeKind.Local).AddTicks(9604),
                            Description = "Chào mừng thành viên mới với ưu đãi giảm 20%",
                            EndDate = new DateTime(2025, 10, 19, 21, 15, 5, 34, DateTimeKind.Local).AddTicks(561),
                            IsActive = true,
                            MaxUses = 100,
                            MinOrderAmount = 50000m,
                            StartDate = new DateTime(2025, 9, 19, 21, 15, 5, 34, DateTimeKind.Local).AddTicks(476),
                        ...
                        new
                        {
                            Id = "promo2",
                            Code = "SAVE30K",
                            CreatedAt = new DateTime(2025, 9, 19, 21, 15, 5, 34, DateTimeKind.Local).AddTicks(794),
                            Description = "Giảm ngay 30.000đ cho đơn hàng từ 200.000đ",
                            EndDate = new DateTime(2025, 10, 19, 21, 15, 5, 34, DateTimeKind.Local).AddTicks(797),
                            IsActive = true,
                            MaxUses = 50,
                            MinOrderAmount = 200000m,
                            StartDate = new DateTime(2025, 9, 19, 21, 15, 5, 34, DateTimeKind.Local).AddTicks(797),
